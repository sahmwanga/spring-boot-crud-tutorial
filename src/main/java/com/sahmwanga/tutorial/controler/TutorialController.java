package com.sahmwanga.tutorial.controler;
...
import com.sahmwanga.tutorial.repository.TutorialRepository;

@CrossOrigin(origins = "http://localhost:4200/api/tutorials")
@RestController
@RequestMapping("/api")
